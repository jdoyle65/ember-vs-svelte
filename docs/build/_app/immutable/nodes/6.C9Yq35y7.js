import{C as e,F as t,G as n,N as r,P as i,x as a}from"../chunks/DIwIDFPt.js";import"../chunks/xihTtKlq.js";import{n as o,r as s,t as c}from"../chunks/Du5nJqbu.js";var l=`<!-- No router config needed. The file system is the router.
...
`,g=e(`<h1 class="mt-4 mb-16 text-6xl font-bold">Routing</h1> <div class="prose mb-12"><p>Ember uses a <strong>central router file</strong> (<code>app/router.js</code>) where all routes
		...
		in the <code>&lt;script&gt;</code> block handle UI state directly. There is no separate layer.</p></div> <div class="flex flex-row gap-12"><div class="flex flex-col gap-4"><!> <!></div></div>`,1);function _(e){var _=g(),v=t(i(_),4),y=r(v),b=r(y);o(b,{});var x=t(b,2);s(x,{get code(){return l},language:`svelte`,filename:`file structure`}),n(y);var S=t(y,2),C=r(S);c(C,{});var w=t(C,2);s(w,{get code(){return u},language:`javascript`,filename:`app/router.js`}),n(S),n(v);var T=t(v,6),E=r(T),D=r(E);o(D,{});var O=t(D,2);s(O,{get code(){return d},language:`typescript`,filename:`src/routes/posts/[id]/+page.ts`});var k=t(O,2);s(k,{get code(){return p},language:`svelte`,filename:`src/routes/posts/[id]/+page.svelte`}),n(E);var A=t(E,2),j=r(A);c(j,{});var M=t(j,2);s(M,{get code(){return f},language:`javascript`,filename:`app/routes/posts/post.js`});var N=t(M,2);s(N,{get code(){return m},language:`hbs`,filename:`app/templates/posts/post.hbs`}),n(A),n(T);var P=t(T,6),F=r(P),I=r(F);c(I,{});var L=t(I,2);s(L,{get code(){return h},language:`javascript`,filename:`app/controllers/posts/post.js`}),n(F),n(P),a(e,_)}export{_ as component};